...
::: info
Consulte nuestra página de [Teoría de Construcción de Naves](/es/shipbuildtheory) para obtener una explicación más detallada detrás de las decisiones de equipamiento.
:::
...
<AxiTab title="Alliance Chieftain (Escudo)">
...
Recomendación: Buen camino de actualización para pilotos seguros. Más potencial a largo plazo.
...
<AxiTab title="Imperial Cutter (Escudo)">
...
<AxiTab title="Krait Mk.II (sin escudos)">
...
<AxiTab title="Alliance Challenger (sin Escudos)">
...
<AxiTab title="Corvette Federal (sin escudos)">
...
<AxiTab title="Federal Corvette (con Escudos)">
...
Vea aún más construcciones de naves visitando nuestra [ Compilacion de construcciones de naves ](/es/buildrepository), una gran colección de construcciones de naves creadas por pilotos AXI experimentados, junto con estadísticas completas, calificaciones y enlaces de construcción.
