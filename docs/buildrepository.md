...
::: warning
Many builds in the repository are NOT recommended for beginners, please be aware and turn to the [Recommended Builds](/builds) or [Speedrun Builds](/speedrunbuilds) page first.
:::
