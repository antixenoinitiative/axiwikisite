...
::: info
Vedi [Teoria di Equipaggiamento Navi](/it/shipbuildtheory) per una spiegazione più approfondita delle scelte di allestimento.
:::
...
<AxiTabs>
<AxiTab title="Krait Mk.II (Shielded)">
...
<AxiTab title="Alliance Chieftain (Shielded)">
...
View even more ship builds by visiting our [Ship Build Repository](/it/buildrepository), a large collection of ship builds built by experienced AXI pilots, along with full stats, ratings, and build links.
...
- Può montare 4 Multi-Cannoni AX negli alloggiamenti grandi
- Ottimi angoli di tiro per i Multi-Cannoni su torretta
- Può montare scudi potenti e potenziatori per una caccia senza preoccupazioni
...
- Può montare 3 Multi-Cannoni AX grandi e 1 medio
- Alternativamente può montare 2 Multi-Cannoni AX grandi e 2 Cannoni Gauss Guardian medi
- Grande mobilità per mantenere i bersagli nel raggio d'azione
- La mobilità permette l'uso di scudi Bi-Weave per disingaggiare e ricaricare
