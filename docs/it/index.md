...
hero:
  name: Anti-Xeno Wiki
  text: Difesa dell'Umanità
  tagline: "Il repository principale per guide al combattimento Anti-Xeno, equipaggiamento navi, tattiche di volo e ricerca scientifica in Elite: Dangerous."
  image:
    src: /axi_logo_new2.png
    alt: Anti-Xeno Initiative Logo
  actions:
    - theme: brand
      text: 🚀 Navi Consigliate
      link: /it/builds
    - theme: alt
      text: ⭐ Guida al Combattimento
      link: /it/basic-combat-guide
    - theme: alt
      text: 🛸 Intercettori
      link: /it/interceptors
    - theme: alt
      text: 💬 Unisciti a Discord
...
<div class="axi-section-header">
  <h2 id="argomenti-popolari">Argomenti Popolari</h2>
  <span class="axi-section-sub">Accesso diretto ai manuali essenziali, configurazioni navi e analisi</span>
</div>
...
<div class="topics-grid">
  <div class="topic-card">
    <div class="topic-card-header">
      ...
      <span class="topic-title">Configurazioni Navi</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">⭐</span>
      <span class="topic-title">Guide al Combattimento</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">🛸</span>
      <span class="topic-title">Intelligence Thargoid</span>
    </div>
...
<div class="axi-section-header">
  <h2 id="community-credits">Crediti della Community</h2>
  <span class="axi-section-sub">Un ringraziamento speciale ai nostri creatori di contenuti, traduttori e sviluppatori! ❤️</span>
</div>

<div class="credits-grid">
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Traduttori & Collaboratori</span>
    ...
    <ul>
      ...
      <li>CMDR Eckee</li>
      <li>e molti altri comandanti</li>
    </ul>
  </div>

  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Creatori di Contenuti</span>
  ...
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Sviluppatori</span>
