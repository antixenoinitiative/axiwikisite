...
date: 2022-01-20T10:15:05.896Z
tags: снаряжение, сборка, теория, инженерные модификации
---
...
Избегайте этих распространённых ошибок, перечисленных [здесь](/ru/commonmistakes).
...
## Другие модули
Информацию о Ксено-сканерах и нейтрализаторах отключающего поля см. на странице [Основное и дополнительное внутреннее оборудование](/ru/internals). Не рекомендуется устанавливать эти два модуля, за исключением особых случаев, поскольку в эти слоты лучше установить теплоотводную катапульту или усилитель щита.