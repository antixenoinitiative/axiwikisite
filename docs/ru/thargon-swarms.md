...
<AxiTab title="Формация конуса/спирали">
...
<AxiTab title="Формация «Стена смерти»">
...
<AxiTab title="Формация «Спираль смерти»">
...
<AxiTab title="Формация «Кольцо смерти»">
