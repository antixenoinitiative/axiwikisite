...
hero:
  name: Anti-Xeno Wiki
  text: Защита Человечества
  tagline: "Основное хранилище инструкций по борьбе с таргоидами, руководств по сборке кораблей, тактик пилотирования и научных исследований в Elite: Dangerous."
  image:
    src: /axi_logo_new2.png
    alt: Anti-Xeno Initiative Logo
  actions:
    - theme: brand
      text: 🚀 Рекомендации по сборке
      link: /ru/builds
    - theme: alt
      text: ⭐ Руководство по бою
      link: /ru/basic-combat-guide
    - theme: alt
      text: 🛸 Перехватчики
      link: /ru/interceptors
    - theme: alt
      text: 💬 Наш Discord
...
<div class="axi-section-header">
  <h2 id="популярные-темы">Популярные темы</h2>
  <span class="axi-section-sub">Прямой доступ к ключевым боевым руководствам, сборкам кораблей и исследованиям</span>
</div>
...
<div class="topics-grid">
  <div class="topic-card">
    <div class="topic-card-header">
      ...
      <span class="topic-title">Сборки кораблей</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">⭐</span>
      <span class="topic-title">Руководства по бою</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">🛸</span>
      <span class="topic-title">Данные о таргоидах</span>
    </div>
...
<div class="axi-section-header">
  <h2 id="community-credits">Благодарности сообществу</h2>
  <span class="axi-section-sub">Огромное спасибо авторам контента, переводчикам и команде разработчиков! ❤️</span>
</div>

<div class="credits-grid">
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Переводчики и авторы</span>
    ...
    <ul>
      ...
      <li>CMDR Eckee</li>
      <li>и многие другие командиры</li>
    </ul>
  </div>

  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Создатели контента</span>
  ...
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Разработчики</span>
