...
hero:
  name: Anti-Xeno Wiki
  text: İnsanlığın Savunması
  tagline: "Elite: Dangerous'ta Anti-Xeno savaş rehberleri, gemi donatım taktikleri, uçuş manevraları ve bilimsel araştırmalar için ana kaynak."
  image:
    src: /axi_logo_new2.png
    alt: Anti-Xeno Initiative Logo
  actions:
    - theme: brand
      text: 🚀 Önerilen Gemiler
      link: /tr/builds
    - theme: alt
      text: ⭐ Savaş Rehberi
      link: /tr/basic-combat-guide
    - theme: alt
      text: 🛸 Interceptorler
      link: /tr/interceptors
    - theme: alt
...
<div class="axi-section-header">
  <h2 id="populer-konular">Popüler Konular</h2>
  <span class="axi-section-sub">Temel savaş kılavuzlarına, gemi donatımlarına ve bilimsel analizlere doğrudan erişim</span>
</div>
...
<div class="topics-grid">
  <div class="topic-card">
    <div class="topic-card-header">
      ...
      <span class="topic-title">Gemi Donatımları</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">⭐</span>
      <span class="topic-title">Savaş Rehberleri</span>
    </div>
  ...
  <div class="topic-card">
    <div class="topic-card-header">
      <span class="topic-icon">🛸</span>
      <span class="topic-title">Thargoid İstihbaratı</span>
    </div>
...
<div class="axi-section-header">
  <h2 id="community-credits">Topluluk ve Emeği Geçenler</h2>
  <span class="axi-section-sub">İçerik üreticilerimize, çevirmenlerimize ve geliştirici ekibimize teşekkürler! ❤️</span>
</div>

<div class="credits-grid">
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Katkıda Bulunanlar</span>
    ...
    <ul>
      ...
      <li>CMDR Eckee</li>
      <li>ve diğer tüm değerli komutanlar</li>
    </ul>
  </div>

  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">İçerik Üreticileri</span>
  ...
  <div class="credits-col">
    <div class="credits-col-header">
      <span class="credits-col-title">Geliştiriciler</span>
