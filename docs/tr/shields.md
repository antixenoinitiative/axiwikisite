...
<AxiTabs>
<AxiTab title="Scanner Varsa">

<img src="/img/withscanner.png" alt="withscanner.png" width="500" />{.align-center} Interceptor'ü hedef aldığınızda, kalkan hologramın çevresinde görülebilir ve "Contacts" panelinde kalan yüzdesi gösterilir.

</AxiTab>
<AxiTab title="Scanner Yoksa">

<img src="/img/withoutscanner.png" alt="withoutscanner.png" width="500" />{.align-center} Scanner'ınız yoksa, Thargoid'e hasar verdiğinizde görebileceğiniz mavi bir parlamayla kalkana sahip olup olmadığını anlayabilirsiniz. Parlamayı görürseniz kalkan hala etkin demektir.
...
<img src="/img/shieldbreak.jpg" alt="shieldbreak.jpg" width="500" />{.align-center}
