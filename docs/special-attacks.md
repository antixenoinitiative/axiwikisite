...
::: info
For detailed breakdown of Thargoid Attack values and other stats, visit our [**Thargoid Spec Sheet**](/thargoid-specs).
:::


<img src="/img/attack_pattern.png" alt="attack_pattern.png" width="550" />{.align-center}
