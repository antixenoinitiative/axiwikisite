...
::: warning
We typically do not recommend starting out with large ships. Interested pilots should also familiarize themselves with the general [AX Flight Manual](/basic-combat-guide) beforehand.
:::
...
The best large ships for AX combat are the Cutter, Corvette, and Anaconda in (roughly) that order.

The Cutter’s principal advantage is its speed and large shield capacity, however, the weapons mounted on its outer wings are only suitable for flak launchers.
...
::: info
Find a selection of reference builds on the [Recommended Builds](/builds) page.
:::
