...
::: info
Bitte lies unsere [Schiffsbautheorie](/de/shipbuildtheory) Seite für eine ausführliche Erklärung hinter den Entscheidungen.
:::
...
<AxiTabs>
<AxiTab title="Krait Mk.II (Schild)">
...
<AxiTab title="Alliance Chieftain (Schild)">
...
<AxiTab title="Imperial Cutter (Schild)">
...
<AxiTabs>
<AxiTab title="Alliance Chieftain (ohne Schild)">
...
<AxiTab title="Krait Mk.II (Ohne Schild)">
...
<AxiTab title="Alliance Challenger (ohne Schild)">
...
<AxiTab title="Federal Corvette (Schildlos)">
...
<AxiTab title="Federal Corvette (Geschildet)">
...
Und noch mehr Builds findet man in unserem [Schiff Build Archiv](/de/buildrepository). Dort sind viele Schiff-Builds mit deren Statistiken, Werten und Build-Links, entworfen von erfahrenen AXI Piloten.
...
- Kann mit starken Schilden und Schildboostern ausgerüstet werden, für sorgloses Jagen
